...
@Data
public class SchoolStudentsRequestDto {
    ...
    private Set<@NotBlank ExtracurricularActivityRequestDto> extracurricularActivities;

    @Size(max = 50, message = "You can include up to 50 classroom entries")
    private Set<@NotBlank AverageStudentsPerClassroomRequestDto> averageStudentsPerClassroom;
