...
const apiGateway = {
  ...
  form: {
    ...
    academics: {
      ...
      update: (schoolId: string, schoolAcademicsId: string) =>
        `/schools/${schoolId}/school-academics/${schoolAcademicsId}` as const,
    },
    facilities: {
      create: (schoolId: string) => `/schools/${schoolId}/school-facilities/` as const,
      update: (schoolId: string, schoolFacilitiesId: string) =>
        `/schools/${schoolId}/school-facilities/${schoolFacilitiesId}` as const,
    },
    staff: {
      create: (schoolId: string) => `/schools/${schoolId}/school-staff/` as const,
      update: (schoolId: string, schoolStaffId: string) =>
        `/schools/${schoolId}/school-staff/${schoolStaffId}` as const,
    },
    media: {
    ...
    students: {
      create: (schoolId: string) => `/schools/${schoolId}/school-students/` as const,
      update: (schoolId: string, schoolStudentsId: string) =>
        `/schools/${schoolId}/school-students/${schoolStudentsId}` as const,
    },
  },
};
